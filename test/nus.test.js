...
describe('Test Node Url Shortener Web App without start_date and end_date - Nus', function () {
  var nus
    , long_url
    , short_url
    , cNew;
...
describe('Test Node Url ShortenerWeb App with start_date and end_date - Nus', function () {
  var nus
    , long_url
    , short_url
    , cNew;
